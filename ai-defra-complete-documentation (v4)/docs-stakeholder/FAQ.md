...
You can ask any question in plain English, but the quality of the answer depends on what documents you have uploaded. The tool only answers from your documents — it does not draw on general AI knowledge. If the answer is not in your documents, it will say so.
