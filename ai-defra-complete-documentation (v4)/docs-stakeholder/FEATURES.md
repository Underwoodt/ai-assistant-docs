...
### Ask questions of their documents

Users type a question in natural language. The tool searches across their uploaded documents, finds the most relevant passages, and uses an AI assistant to compose a clear answer based on that content. The answer is grounded in the documents — not generated from the AI's general knowledge.
