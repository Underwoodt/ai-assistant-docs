...
|---|---|
| [ARCHITECTURE.md](ARCHITECTURE.md) | Full system diagram, service responsibilities, data flows, sequence diagrams for chat and document upload, auth layers, RAG implementation notes |
